...
export async function GET(request) {
  try {
    ...
    const introduction = await fetchData(
      "Introduction",
      { comp: "docId", sign: "==", val: artistId },
      false
    );
    const investmentPoints = await fetchData(
      "InvestmentPoint",
      { comp: "artist_id", sign: "==", val: artistId },
      true
    );
