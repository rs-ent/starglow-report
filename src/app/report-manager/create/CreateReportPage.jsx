...
export default function CreateReportPage() {
    ...
    const handleChange = (e) => {
        ...
        if (name === 'project_launch_date' || name === 'project_deadline_date') {
            const launchDate = name === 'project_launch_date' ? new Date(newValue) : new Date(formData.project_launch_date);
            const deadlineDate = name === 'project_deadline_date' ? new Date(newValue) : new Date(formData.project_deadline_date);
            ...
            <div className="w-full max-w-3xl p-6 rounded-lg shadow-xl bg-[var(--background-second)]">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <fieldset className="border border-[var(--border-mid)] rounded p-4 mb-6">
                        <legend className="px-2 text-xl font-bold text-gradient">Artist Information</legend>
                        <div className="space-y-4">
                            <div>
                                <label htmlFor="artist_eng" className="block font-semibold mb-2">
                                    Artist (Eng):
                                </label>
                                <input
                                    type="text"
                            ...
                            <div>
                                <label htmlFor="artist_kor" className="block font-semibold mb-2">
                                    Artist (Kor):
                                </label>
                                <input
                                    type="text"
                    ...
                    {/* Report Details */}
                    <fieldset className="border border-[var(--border-mid)] rounded p-4 mb-6">
                        <legend className="px-2 text-xl font-bold text-gradient">Report Details</legend>
                        <div className="space-y-4">
                            <div>
                            ...
                            <div>
                                <label htmlFor="image_alpha_file" className="block font-semibold mb-2">
                                    Image Alpha:
                                </label>
                                <input
                                    type="file"
                                ...
                                {formData.image_alpha && !uploading && (
                                    <div className="mt-2">
                                        <img src={formData.image_alpha} alt="Uploaded Preview" className="w-64 h-auto rounded mt-2" />
                                    </div>
                                )}
                            </div>
                        </div>
                    ...
                    {/* Dates */}
                    <fieldset className="border border-[var(--border-mid)] rounded p-4 mb-6">
                        <legend className="px-2 text-xl font-bold text-gradient">Dates</legend>
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <label htmlFor="nft_sales_start" className="block font-semibold mb-2">
                                    NFT 판매 시작일:
                                </label>
                                <input
                                    type="date"
                            ...
                            <div>
                                <label htmlFor="nft_sales_end" className="block font-semibold mb-2">
                                    NFT 판매 종료일:
                                </label>
                                <input
                                    type="date"
                            ...
                            <div>
                                <label htmlFor="glow_start" className="block font-semibold mb-2">
                            ...
                            <div className="col-span-2">
                                <label htmlFor="settlement_date" className="block font-semibold mb-2">
                                    투자자 정산일:
                                </label>
                                <input
                                    type="date"
                    ...
                    {/* Funding Information */}
                    <fieldset className="border border-[var(--border-mid)] rounded p-4 mb-6">
                        <legend className="px-2 text-xl font-bold text-gradient">Funding Information</legend>
                        <div className="mb-4">
                            <label htmlFor="goal_fund" className="block font-semibold mb-2">
                                목표 금액 : {formatNumber(formData.goal_fund, ' $', 0, 'en')} ≈ {formatNumber(formData.goal_fund / exchangeRate, '원', 3, 'ko')}
                            </label>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <label htmlFor="minted_nft" className="block font-semibold mb-2">
                            ...
                            <div>
                                <label htmlFor="nft_price" className="block font-semibold mb-2">
                                    NFT Price ($): {formatNumber(formData.nft_price, ' $', 0, 'en')} ≈ {formatNumber(formData.nft_price / exchangeRate, '원', 3, 'ko')}
                                </label>
                                <div className='flex items-center text-lg'>
                                    <p className='mr-1'>$</p>
                                    <input
                    ...
                    <fieldset className="border border-[var(--border-mid)] rounded p-4 mb-6">
                        <legend className="px-2 text-xl font-bold text-gradient">Investor Information</legend>
                        <div className="grid grid-cols-1 gap-4">
                            <div>
                                <label htmlFor="investors_share_ratio" className="block font-semibold mb-2">
                                    Investors Share Ratio: 매출의 {formData.investors_share_ratio * 100}%를 투자자에게 배분
                                </label>
                                <input
                                    type="number"
                                    step="0.01"
                    ...
                    <fieldset className="border border-[var(--border-mid)] rounded p-4">
                        <legend className="px-2 text-xl font-bold text-gradient">Additional Settings</legend>
                        <div>
                            <label htmlFor="pre_applier_count" className="block font-semibold mb-2">
                                Pre Applier Count:
                            </label>
                            <input
                                type="number"
